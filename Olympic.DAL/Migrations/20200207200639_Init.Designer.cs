            ...
            modelBuilder.Entity("Olympic.DAL.Database.Entities.Olympicon", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Age = 25, Birthday = new DateTime(1995, 6, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), Forename = "John", NationalityId = 1, Sport = 0, Surname = "Doe" },
                        new { Id = 2, Age = 30, Birthday = new DateTime(1990, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), Forename = "Jane", NationalityId = 1, Sport = 2, Surname = "Doe" },
                        new { Id = 3, Age = 25, Birthday = new DateTime(1996, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), Forename = "Er", NationalityId = 2, Sport = 3, Surname = "Cycl" },
                        new { Id = 4, Age = 25, Birthday = new DateTime(1995, 7, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), Forename = "Ther", NationalityId = 3, Sport = 5, Surname = "Fig" }
                    );
                });
